...
class ProbeSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Probe::insert (['id'=>4, 'name'=>'Ssh', 'ping_probe'=>'0', 'http_probe'=>'0',  'https_probe'=>'0',
        	...
        	'created_at'=>Carbon::now(), 'updated_at'=>Carbon::now()]);
        Probe::insert (['id'=>5, 'name'=>'Ftp', 'ping_probe'=>'0', 'http_probe'=>'0',  'https_probe'=>'0',
        	'socket_probe'=>'1', 'ssl_probe'=>'0', 'mysql_probe'=>'0', 'draw_graph'=>'0', 
        	'created_at'=>Carbon::now(), 'updated_at'=>Carbon::now()]);
        Probe::insert (['id'=>6, 'name'=>'SSL', 'ping_probe'=>'0', 'http_probe'=>'0',  'https_probe'=>'0',
        	'socket_probe'=>'0', 'ssl_probe'=>'1', 'mysql_probe'=>'0', 'draw_graph'=>'0', 
        	'created_at'=>Carbon::now(), 'updated_at'=>Carbon::now()]);
        Probe::insert (['id'=>7, 'name'=>'MySQL', 'ping_probe'=>'0', 'http_probe'=>'0',  'https_probe'=>'0',
